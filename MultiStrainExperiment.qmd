---
title: "Multi-strain Simulation"
author: "Miguel Fudolig"
format: html
editor: visual
---

## Multi-strain SIR Experiment 

This is an abridged version of the code used to perform a simulation-based experiment for the manuscript submitted to *Microorganisms*.

## Code

We import the relevant packages: tidyverse and emmeans
...
Next, we write the function to simulate the stochastic SIR model. We assume an arbitrary population of 100,000, an assumption based on how surveillance data is being reported for COVID-19 cases. This population number will be cancelled out when we solve for infected proportions.
...
Now, we write a function that will calculate the time to dominance (TTD).
